...
//     while (secion.firstChild){
//         secion.removeChild(section.firstChild);
//     }
...
function onClientLoad() {
    gapi.client.load('youtube/channels', 'v3', onYouTubeApiLoad)
}
// function onClientLoad() {
//     gapi.client.load()
// }
...
function search(e) {
    ...
    let request = gapi.client.youtube.channelId({
